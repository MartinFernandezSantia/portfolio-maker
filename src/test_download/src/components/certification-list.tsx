      ...
      <Card className="p-8 h-fit">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-xl font-semibold">
            <span className="gradient-text">Certificaciones</span> Profesionales
          </h3>
        </div>
        ...
        >
          <p className="text-sm text-muted-foreground text-center">
            Comprometido a mantenerme actualizado con las tecnologías emergentes y las mejores prácticas de la industria
          </p>
        </motion.div>
      </Card>
    </motion.div>
